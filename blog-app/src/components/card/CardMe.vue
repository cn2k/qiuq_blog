<template>
  <el-card>
    <h1 class="me-author-name">小宇博客</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;湖北&武汉</span>
      <span><i class="me-icon-job"></i> &nbsp;java技术砖家</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '3353586946'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://space.bilibili.com/549314116">https://space.bilibili.com/549314116</a>'
        }
      }
    },
    methods: {
